...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /home/zq610/LPH/src/turtlebot_simulator-indigo/turtlebot_gazebo)
  set(turtlebot_gazebo_DEVEL_PREFIX /home/zq610/LPH/devel)
  ...
  set(turtlebot_gazebo_INSTALL_PREFIX /home/zq610/LPH/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zq610/LPH/src/turtlebot_simulator-indigo/turtlebot_gazebo/${idir}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zq610/LPH/devel/lib;/home/zq610/WYZ/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
