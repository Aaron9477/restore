...
(cl:defmethod cl:initialize-instance :after ((m <output>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'output)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tld_origin-msg:<output> is deprecated: use tld_origin-msg:output instead.")))

(cl:ensure-generic-function 'output-val :lambda-list '(m))
(cl:defmethod output-val ((m <output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tld_origin-msg:output-val is deprecated.  Use tld_origin-msg:output instead.")
  (output m))
